                ...
                <DialogContent className="sm:max-w-[425px] overflow-y-scroll max-h-screen">
                    ...
                    <div className="dialog__main">
                        ...
                        <div>
                            ...
                            <Input className="bg-[#F2F4F7]" placeholder="+998 90 124-25-25"></Input>
                            <Input className="bg-[#F2F4F7]" placeholder="+998 90 124-25-25"></Input>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4 items-center justify-center">
                                <Input className="bg-[#F2F4F7]" placeholder="г. Ташкент, улица Мукими, 166 ..."></Input>
                                <button><i className="fa-regular fa-circle-xmark"></i></button>
                            </div>
                            ...
                            <Select>
                                ...
                                <SelectContent className="bg-[#F2F4F7]">
                                    <SelectGroup>
                                        <SelectLabel className="bg-[#F2F4F7]">Выберите район</SelectLabel>
                                        <SelectItem className="bg-[#F2F4F7]" value="apple">Чиланзарский район</SelectItem>
                                        <SelectItem className="bg-[#F2F4F7]" value="strawberry">Алмазарский район</SelectItem>
                                        <SelectItem className="bg-[#F2F4F7]" value="banana">Мирзо-Улугбекский район</SelectItem>
                                        <SelectItem className="bg-[#F2F4F7]" value="blueberry">Учтепинский район</SelectItem>
                                        <SelectItem className="bg-[#F2F4F7]" value="grapes">Ташкентская область</SelectItem>
                                    </SelectGroup>
                                </SelectContent>
                            </Select>
                            ...
                            <div className="dialog__grid">
                                ...
                                <Input className="bg-[#F2F4F7]" placeholder="Номер квартиры"></Input>
                                <Input className="bg-[#F2F4F7]" placeholder="Код домофона"></Input>
                            </div>
                    ...
                    <DialogFooter className={'flex'}>
                        <Button className='dialog__submit w-full rounded-full'>Сохранить</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
